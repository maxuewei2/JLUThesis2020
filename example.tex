...
\usepackage[hardcopy,makebox,phdplain]{jluthesis2020}%phdplain
...
% 手动在长标题中利用 \par 输入断行，
\ctitle{吉林大学学位论文排版v0.2示例}
\cspinetitle{\printSpine{\printChinese{吉林大学学位论文排版}v0.2\printChinese{示例}}}
\etitle{Sample Typesetting for JLUThesisLaTeX v0.2}
\csubject{计算机应用技术}   % 封面的『专业』或『类别』
\cinterest{数据挖掘}  % 封面的『研究方向』或『领域（方向）』，博士精装版扉页的『研究方向』
\csubjectscd{计算机应用技术}  % 扉页的『专业名称』或『领域（方向）』
\csubjecttrd{计算机应用技术}  % 学位论文授权说明中的『学科专业』
\cdegree{工学博士}  % 扉页的『学位类别』或『类别』
\ccollege{计算机科学与技术学院}
\collegenumber{10183}
\cuniversity{吉林大学}
\cauthor{马学威}
...
% 以下日期若注释掉，对应的日期将留空
\dateForCover{2020}{3}
\degreeObtainDate{2020}{7}{12}
\defenseDate{2020}{6}{12}
\originalStatementDate{2020}{4}{1}
\contributionStatementDate{2020}{5}{1}
