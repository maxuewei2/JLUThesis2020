\documentclass[oneside,a4paper,12pt]{book}%,AutoFakeBold,twoside,openright,
...
% onlyCover 仅输出封面页
% twoSideCover 输出双页封面
% 默认为 hardcopy,amd，且nobox=false，manualSpine=false，onlyCover=false，twoSideCover=false
...
\jluSpineHorizontalPosition{1.45} % 书脊的水平位置，修改可使书脊水平平移
...
% 以下日期若注释掉，对应的日期将留空
\jluDateForCover{2020}{3}
\jluDegreeObtainDate{2020}{7}{12}
\jluDefenseDate{2020}{6}{12}
\jluOriginalStatementDate{2020}{4}{1}
\jluContributionStatementDate{2020}{5}{1}
...
\jluReferenceStyle{gbt7714-numerical}
\jluPrintRefrence
